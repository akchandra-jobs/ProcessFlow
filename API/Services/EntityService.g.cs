...
namespace ProcessFlow.Services
{
    ...
    public interface IEntityService
    {
        ...
        List<Entity> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
    ...
    public class EntityService : IEntityService
    {
        ...
        public EntityService(ProcessFlowContext dbContext)
        {
        ...
        public List<Entity> Get(string filters, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
