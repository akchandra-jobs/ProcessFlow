...
namespace ProcessFlow.Services
{
    ...
    public interface IUserInRoleService
    {
        ...
        List<UserInRole> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
    ...
    public class UserInRoleService : IUserInRoleService
    {
        ...
        public UserInRoleService(ProcessFlowContext dbContext)
        {
        ...
        public List<UserInRole> Get(string filters, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
