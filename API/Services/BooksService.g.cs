...
namespace ProcessFlow.Services
{
    ...
    public interface IBooksService
    {
        ...
        List<Books> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
    ...
    public class BooksService : IBooksService
    {
        ...
        public BooksService(ProcessFlowContext dbContext)
        {
        ...
        public List<Books> Get(string filters, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
