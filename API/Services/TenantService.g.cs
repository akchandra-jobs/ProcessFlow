...
namespace ProcessFlow.Services
{
    ...
    public interface ITenantService
    {
        ...
        List<Tenant> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
    ...
    public class TenantService : ITenantService
    {
        ...
        public TenantService(ProcessFlowContext dbContext)
        {
        ...
        public List<Tenant> Get(string filters, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
