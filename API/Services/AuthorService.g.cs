...
namespace ProcessFlow.Services
{
    ...
    public interface IAuthorService
    {
        ...
        List<Author> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
    ...
    public class AuthorService : IAuthorService
    {
        ...
        public List<Author> Get(string filters, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
