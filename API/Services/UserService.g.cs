...
namespace ProcessFlow.Services
{
    ...
    public interface IUserService
    {
        ...
        List<User> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
    ...
    public class UserService : IUserService
    {
        ...
        public UserService(ProcessFlowContext dbContext)
        {
        ...
        public List<User> Get(string filters, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
