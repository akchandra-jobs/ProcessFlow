...
namespace ProcessFlow.Services
{
    ...
    public interface IRoleService
    {
        ...
        List<Role> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
    ...
    public class RoleService : IRoleService
    {
        ...
        public RoleService(ProcessFlowContext dbContext)
        {
        ...
        public List<Role> Get(string filters, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
