...
using ProcessFlow.Filter;
using ProcessFlow.Entities;
using ProcessFlow.Logger;
...
namespace ProcessFlow.Services
{
    ...
    public interface IRoleEntitlementService
    {
        ...
        List<RoleEntitlement> Get(string filters, string searchTerm, int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
    ...
    public class RoleEntitlementService : IRoleEntitlementService
    {
        ...
        public RoleEntitlementService(ProcessFlowContext dbContext)
        {
        ...
        public List<RoleEntitlement> Get(string filters, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
