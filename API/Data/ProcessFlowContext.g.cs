...
namespace ProcessFlow.Data
{
    ...
    /// </summary>
    public class ProcessFlowContext : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-HN6RHOU\\SQLEXPRESS;Initial Catalog=T388042_ProcessFlow;Persist Security Info=True;user id=sa;password=admin;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
