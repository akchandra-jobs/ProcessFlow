...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ProcessFlow", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<ProcessFlowContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "ProcessFlow API v1");
